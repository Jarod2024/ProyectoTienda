        ...
        <div class="container py-5 h-100 d-flex justify-content-center align-items-center">
            <div class="row justify-content-center align-items-center w-100">
                <div class="col-xl-10 col-lg-12">
                    <div class="card rounded-3 text-black" style="background-color: rgba(255, 255, 255, 0.7); padding: 20px; margin: 0 auto;">
                        <div class="row g-0">
                            ...
                            <div class="col-lg-6 d-flex align-items-center gradient-custom-2">
                                <div class="text-white px-3 py-4 p-md-5 mx-md-4 text-center">
                                    <img src="{{asset('images/Logo1.jpg')}}" style="width: 100%; max-width: 400px; height: auto; border-radius: 50%; box-shadow: 0px 4px 15px rgba(156, 131, 164, 0.1); object-fit: cover;" alt="logo">
                                </div>
                            </div>
                        </div>
                    </div>
